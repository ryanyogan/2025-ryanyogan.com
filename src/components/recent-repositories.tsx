...
export function RecentRepositories({ repos }: RecentRepositoriesProps) {
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-serif font-normal text-gray-800 dark:text-zinc-400 pb-2 relative inline-block">
      ...
      <div className="grid gap-x-8 gap-y-6">
        {repos.map((repo) => (
          ...
          >
            ...
            {repo.description ? (
              <p className="mt-2 text-base text-zinc-800 dark:text-zinc-100 font-serif line-clamp-1 tracking-tight">
                {repo.description}
              </p>
            ) : (
